...
INSERT INTO "messenger".message (toLogin, fromLogin, dateTime, "message") VALUES ('Vic', 'Alex', '2022-02-28 13:50:29', 'Hello Vic!');
...
SELECT fromLogin, dateTime, "message" FROM "messenger".message WHERE tologin = 'Vic';
